...
class Mt_client extends CI_Controller
{
    ...
    {
        parent::__construct();
        $this->load->model('Mt_client_model');
        $this->load->library('form_validation');
    }

    public function index()
    {
        $mt_client = $this->Mt_client_model->get_all();

        $data = array(
            'mt_client_data' => $mt_client
        );
    ...
    {
        $row = $this->Mt_client_model->get_by_id($id);
        if ($row) {
            $data = array(
    ...
    public function create() 
    {
        $data = array(
            'button' => 'Create',
            'action' => site_url('mt_client/create_action'),
    ...
    public function create_action() 
    {
		...
		'id_session' => $this->input->post('id_session',TRUE),
            ...
            $this->Mt_client_model->insert($data);
    ...
    public function update($id) 
    {
        ...
        if ($row) {
            $data = array(
                'button' => 'Update',
                'action' => site_url('mt_client/update_action'),
    ...
    public function update_action() 
    {
		...
		'id_session' => $this->input->post('id_session',TRUE),
            ...
            $this->Mt_client_model->update($this->input->post('client_id', TRUE), $data);
    ...
    public function delete($id) 
    {
        ...
        if ($row) {
            $this->Mt_client_model->delete($id);
...
/* End of file Mt_client.php */
/* Location: ./application/controllers/Mt_client.php */
/* Please DO NOT modify this information : */
/* Generated by Harviacode Codeigniter CRUD Generator 2017-06-02 03:41:33 */
/* http://harviacode.com */